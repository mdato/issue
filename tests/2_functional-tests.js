        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
                "_id":"60f47d9ade091e22b45a5958",
                "issue_title":"algo",
                "issue_text":"tercer mensaje",
                "created_on":"2021-07-18T19:14:34.674Z",
                "updated_on":"2021-07-18T19:14:34.674Z",
                "created_by":"marce",
                "assigned_to":"",
                "open":true,
                "status_text":"",
      ...
      test("View issues on a project with multiple filters: GET request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.deepEqual(res.body[0], {
                "_id":"60f48193f78bd326e8629a40",
                "issue_title":"algo",
                "issue_text":"hola",
                "created_on":"2021-07-18T19:31:31.009Z",
                "updated_on":"2021-07-18T19:31:31.009Z",
                "created_by":"marce",
                "assigned_to":"",
                "open":true,
                "status_text":""
    ...
    suite("5 Put request Tests", function () {
      test("Update one field on an issue: PUT request to /api/issues/test-data-put", function (done) {
        chai
          ...
          .send({
            _id: "60f484098a4542143495f563",
            issue_title: "different",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "60f484098a4542143495f563");
